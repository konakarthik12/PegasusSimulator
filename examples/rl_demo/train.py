...
my_env = DroneEnv(headless=False)
...
checkpoint_callback = CheckpointCallback(save_freq=10000, save_path=log_dir, name_prefix="drone_policy_checkpoint")
model = PPO(
    policy,
    my_env,
...
model.save(log_dir + "/drone_policy")
